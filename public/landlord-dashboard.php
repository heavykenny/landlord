    ...
    <section class="section-t8">
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h2 class="text-center mb-4 text-brand">Landlord Dashboard</h2>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card text-center bg-primary text-white">
                                <div class="card-body">
                                    <h5 class="card-title title-a">My Properties</h5>
                                    <a href="landlord-manage-properties.php" class="btn btn-a btn-sm">Manage</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card text-center bg-success text-white">
                                <div class="card-body">
                                    <h5 class="card-title title-a">Inquiries</h5>
                                    <a href="landlord-manage-inquiries.php" class="btn btn-a btn-sm">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
